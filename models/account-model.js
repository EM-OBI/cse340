...
async function getAccountById (account_id) {
    try {
        ...
        return new Error ("Account enquiry failed")
    }
}
...
* ***************************** */
async function updatePersonal (account_firstname, account_lastname, account_email, account_id) {
    try {
...
module.exports = {registerAccount, checkExistingEmail, getAccountByEmail, getAccountById, updatePersonal, updatePassword}